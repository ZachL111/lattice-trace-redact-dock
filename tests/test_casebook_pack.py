"""Regression checks for the lattice-trace-redact-dock casebook."""
...
from casebook.harness import assert_expected, lattice_trace_redact_dock_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(lattice_trace_redact_dock_summary(), assert_expected())
